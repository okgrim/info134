...
function initialize() {
       ...
       var locations = [
           ...
           '<img src="../img/ricksInfo.png" alt="bilde av Rickslogo" style="height:100px;width:150px"></br>'+
           ...
           'visit Don Pippo!</br>'+
           '<img src="../img/donPippoInfo.jpg" alt="bilde av Don Pippo" style="height:100px;width:150px"></br>'+
           '<i>Adress: Christies gate 11, 5015 Bergen </i>'
           , 60.389680, 5.322974],
           ['</b>Garage</b> is known for being a watering hole for the alternative</br>'+
           'Should the lounge, hip-hop or electro scene not be your thing,</br> '+
           'make sure to visit garage </br>'+
           '<img src="../img/GarageInfo.jpg" alt="bilde av Garage" style="height:100px;width100px;"></br>'+
           ...
           '<img src="../img/noStressInfo.jpg" alt="bilde av No Stress" style="height:100px;width:175px"></br>'+
           ...
           '<img src="../img/biskopenInfo.jpg" alt="bilde av Biskopen" style="height:100px;width:150px"></br>'+
